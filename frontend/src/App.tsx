...
function RiskSummaryIcon({ status }: { status: InventoryExpiryStatus }) {
  if (status === 'expiring') {
    return <svg className="p7-risk-icon" data-icon="vaadin:clock" viewBox="0 0 16 16" aria-hidden="true"><path d="M8 0C3.6 0 0 3.6 0 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8m0 14c-3.3 0-6-2.7-6-6s2.7-6 6-6 6 2.7 6 6-2.7 6-6 6" /><path d="M8 3H7v6h5V8H8z" /></svg>
  }
