...
function MeHome({ theme, notificationCount, onNotifications, onNotificationSettings, onAbout, onPreferences, onHome, onRecipes, onShopping, onSwitchAccount }: { theme: ThemeKey; notificationCount: number; onNotifications: () => void; onNotificationSettings: () => void; onAbout: () => void; onPreferences: () => void; onHome: () => void; onRecipes: () => void; onShopping: () => void; onSwitchAccount?: () => void }) {
  ...
  return <>
    <PageShell className="p7-shell p7-top-level" header={<AppHeader title="我的" />} bodyClassName="p7-scroll p7-settings" footer={<P7Navigation active="me" onHome={onHome} onRecipes={onRecipes} onShopping={openShopping} onMe={() => undefined} notificationCount={notificationCount} />}>
      ...
      <section>
        ...
        <button type="button" className="p7-link-row" onClick={onNotificationSettings}><span><b>通知与权限</b><small>本机提醒时间和系统通知权限</small></span><b aria-hidden="true">›</b></button>
