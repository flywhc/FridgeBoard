  ...
  useEffect(() => {
    ...
    editing.ingredients.forEach((ingredient, index) => {
      ...
      const timer = window.setTimeout(() => {
        ...
        void matchIngredient(itemName, controller.signal, length => setIngredientMatchTextLengths(current => ({ ...current, [key]: length })))
          .then(result => {
