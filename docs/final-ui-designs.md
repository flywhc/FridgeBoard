...
下列场景尚无确认后的最终设计资产，现有安装/配对稿只能提供视觉参考，不得继续沿用其中已被
新流程替换的文案或状态语义：

| 场景 | 当前依据 | 状态 |
| --- | --- | --- |
| 手机空首页：扫码与登录双入口 | 流程设计 §5.1 | 待设计 |
| 通用冰箱二维码扫描页 | 流程设计 §5.2 | 待设计 |
| 未完成冰箱列表与继续设置 | 流程设计 §5.3 | 待设计 |
| 布局完成后的绑定引导 | 流程设计 §5.4 | 待设计 |
| 冰箱设置：绑定与换绑冰箱端 | 流程设计 §5.5 | 待设计 |
| Kindle 首次使用/已安装双路径提示 | 流程设计 §7.1 | 待设计 |
| Kindle 等待手机完成布局 | 流程设计 §6.1 | 待设计 |

这些资产确认并登记前，不实施对应新 UI；领域模型、API 契约和测试设计可先行。
