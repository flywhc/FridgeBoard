...
| P7 | 手机端日常首页与冰箱管理 | 待评审 | P3、P4、P5 | 2026-07-24 手机导航重构 | 已按线框重构四个一级页、底部导航和二级页返回关系；前端 lint/build 与 diff 检查通过，待真实登录态和手机 PWA 验收。 |
| P7.1 | 冰箱资料、已有布局与删除 | 待评审 | P4、P7、P10 | 2026-07-24 P7.1 设置页修正与生产发布 | 已移除不成立的兼容绑定码入口，并改为全宽危险操作按钮；提交 `8c15463` 已发布。 |
