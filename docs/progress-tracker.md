...
| P4 | 冰箱模板、布局配置与位置选择 | 待评审 | P2、P3 | 2026-08-02 冰箱预览尺寸契约重构会话 | `OpenFridge` 只负责模板几何，五类页面展示边界统一由 `FridgePreviewFrame` 管理；0–8 格、宽体双门和迷你 50/50 在 320/390/430px 回归通过，待真机视觉评审。 |
...
| P7 | 手机端日常首页与冰箱管理 | 待评审 | P3、P4、P5 | 2026-08-02 冰箱预览尺寸契约重构会话 | 首页标准、宽体和迷你模板共用 home 场景；“家里冰箱 4”在 320/390/430px 为 260/330/358px 宽并保持上下 50/50，待真机视觉评审。 |
...
| P11 | 端到端验收与发布准备 | 进行中 | P3、P6、P8、P9、P10、P10.5 | 2026-08-02 旧版分类数据转换与库存图标恢复会话 | 已完成生产只读盘点；待完成迁移前备份、数据转换、容器发布和真实 PWA/冰箱端刷新验收。 |
